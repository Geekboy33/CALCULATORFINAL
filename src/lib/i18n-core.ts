...
export const translations: Record<Language, Translations> = {
  es: {
    ...
    auditDataPath: 'Ruta de Datos DTC1B',
    ...
    auditLoadFile: 'Cargar Archivo DTC1B',
    ...
    auditAnalyzerDescription: 'Bank Audit está escuchando datos del Analizador en tiempo real. Cuando proceses un archivo DTC1B en el Analizador, los datos aparecerán AUTOMÁTICAMENTE aquí.',
  ...
  en: {
    ...
    auditAnalyzerDescription: 'Bank Audit is listening to data from the Analyzer in real-time. When you process a DTC1B file in the Analyzer, the data will appear AUTOMATICALLY here.',
